...
/* 19 */ _CFFI_OP(_CFFI_OP_POINTER, 20), // double * *
/* 20 */ _CFFI_OP(_CFFI_OP_POINTER, 14), // double *
/* 21 */ _CFFI_OP(_CFFI_OP_STRUCT_UNION, 0), // freespace
/* 22 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 7), // int
/* 23 */ _CFFI_OP(_CFFI_OP_POINTER, 24), // point *
/* 24 */ _CFFI_OP(_CFFI_OP_STRUCT_UNION, 1), // point
...
static void _cffi_d_setreachabilitytable(void)
{
  setreachabilitytable();
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_setreachabilitytable(PyObject *self, PyObject *noarg)
{
...
#else
#  define _cffi_f_setreachabilitytable _cffi_d_setreachabilitytable
#endif
...
static const struct _cffi_global_s _cffi_globals[] = {
  ...
  { "gethorizontalverticies", (void *)_cffi_f_gethorizontalverticies, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_N, 4), (void *)_cffi_d_gethorizontalverticies },
  { "getverticalcurve", (void *)_cffi_f_getverticalcurve, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_N, 6), (void *)_cffi_d_getverticalcurve },
  { "getverticalverticies", (void *)_cffi_f_getverticalverticies, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_N, 4), (void *)_cffi_d_getverticalverticies },
...
static const struct _cffi_struct_union_s _cffi_struct_unions[] = {
  { "freespace", 21, _CFFI_F_CHECK_FIELDS,
    sizeof(freespace), offsetof(struct _cffi_align__freespace, y), 0, 4 },
  { "point", 24, _CFFI_F_CHECK_FIELDS,
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__strong_distance(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__strong_distance(void) { return NULL; }
#  else
     init_strong_distance(void) { }
#  endif
#  endif
#elif PY_MAJOR_VERSION >= 3
PyMODINIT_FUNC
PyInit__strong_distance(void)
{
  return _cffi_init("_frechet._strong_distance", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_strong_distance(void)
{
  _cffi_init("_frechet._strong_distance", 0x2601, &_cffi_type_context);
}
#endif
