...
supporting packages can be found in [/docs/doxygen](/docs/doxygen).
...
483279.000000 4213421.000000
483333.000000 4213468.000000
483335.000000 4213515.000000
483309.000000 4213528.000000
483326.000000 4213552.000000
483327.763412 4213555.022993
```
**curve_2_file.txt**
```
484472 4.21292e+006
...
strong_distance = StrongDistance.setCurves("curve_1_file.txt", "curve_2_file.txt")
print(strong_distance)

weak_distance = WeakDistance.setCurves("curve_1_file.txt", "curve_2_file.txt")
print(weak_distance)
```
**output**
```
